...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0,      uint256("0x000007cabcfba44b7a728f1746bdec842c9fefab32e8e9df3e18d28ecc265eb3"))
    ...
    (398700, uint256("0xe76678effe4c52bb598f55b9e75a51a4b7ab855fbb39efac021845891e271688"))
    (404000, uint256("0x4174ce85eaf7f88a3d4e4bbf948192a706b7e23362a7aa68733ecf5ede721794"))
    (415000, uint256("0x19354a89d6f13fe48813d5dd07e5e1022466705e318c0c6d2c1045ce319a9d63"))
    (420000, uint256("0x2914033d193c775cc569d321f3de5760b4cf0b5e9feebf55dcaa53cbb694667e"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1601353637, // * UNIX timestamp of last checkpoint block
    938138,     // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1*60;  // MalwareChain POW not so fast as we can
        nTargetSpacing =  1*60;
        nMaturity = 180;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "November 18, 2019: Linux, Windows Users Targeted With New ACBackdoor Malware";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d841cf5f76985b48858cee0915f7a543b1b9c384869ec3e8e2e0822530882ccb4b546cffbf54cf0a0853b09647932e7aa89ccfbd2bb27b021c9bf47997ca970b") << OP_CHECKSIG;
        ...
        vSeeds.push_back(CDNSSeedData("dns", "nodes.malwarechain.com"));
        ...
        strSporkKey = "0400a7f68f2747c07d13d8f5b23dae4a786fefa7ad0ff18c6e14c89317e375dd0ea72831a24c5feaf95f8e9935954b9bfc0e024dba0823e8d09c80c5015aad5f9b";
        strObfuscationPoolDummyAddress = "MeGTNR1oWEbsTaNvxpUM6xh1zCS8AEqrUG";
        ...
        nZerocoinLastOldParams = 98765432; // Updated to defer zerocoin v2 for further testing.
